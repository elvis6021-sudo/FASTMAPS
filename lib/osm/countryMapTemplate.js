...
function buildCountryLayers(code) {
  ...
  return [
    ...
    { file: f('Tertiary'), description: 'Tertiary casing (OSM)', lineColor: rgb(143, 143, 143), lineWidth: 4, zoomMax: 40, autoLabel: false },   // @tertiary-casing #8f8f8f
    { file: f('Secondary'), description: 'Secondary casing (OSM)', lineColor: rgb(112, 125, 5), lineWidth: 5, zoomMax: 150, autoLabel: false },   // @secondary-casing #707d05
    ...
    { file: f('Tertiary'), description: 'Tertiary (OSM)', lineColor: rgb(255, 255, 255), lineWidth: 2, zoomMax: 40, labelZoomMax: 20 },          // @tertiary-fill #ffffff
    { file: f('Secondary'), description: 'Secondary (OSM)', lineColor: rgb(247, 250, 191), lineWidth: 3, zoomMax: 150, labelZoomMax: 30 },        // @secondary-fill #f7fabf
