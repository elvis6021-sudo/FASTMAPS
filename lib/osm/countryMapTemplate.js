...
function buildCountryLayers(code) {
  ...
  return [
    ...
    // ─── FASE 2: jerarquía de GROSOR (calles finas < avenidas < principales) ───────────────────
    // AllStreets (calles locales/residenciales): las más FINAS. En OSM-Carto es blanco con casing
    // gris; sin casing todavía usamos el gris del casing #bbbbbb para que la línea se lea.
    ...
    // Highway2 (avenidas = secundarias/terciarias): grosor MEDIO. OSM-Carto @secondary-fill #f7fabf
    { file: f('Highway2'), description: 'Highway_2 (OSM)', lineColor: rgb(247, 250, 191), lineWidth: 3, labelZoomMax: 30, thickRoad: true },
    // Highway1 (principales/autopistas): las más GRUESAS. OSM-Carto @primary-fill #fcd6a4
    { file: f('Highway1'), description: 'Highway_1 (OSM)', lineColor: rgb(252, 214, 164), lineWidth: 5, labelZoomMax: 60, thickRoad: true },
