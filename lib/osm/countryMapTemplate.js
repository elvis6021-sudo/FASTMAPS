...
function buildCountryLayers(code) {
  ...
  return [
    ...
    { file: f('AllStreets'), description: 'AllStreets casing (OSM)', lineColor: rgb(187, 187, 187), lineWidth: 3, zoomMax: 10, autoLabel: false },
    { file: f('Highway2'), description: 'Highway_2 casing (OSM)', lineColor: rgb(112, 125, 5), lineWidth: 5, autoLabel: false },   // @secondary-casing #707d05
    { file: f('Highway1'), description: 'Highway_1 casing (OSM)', lineColor: rgb(160, 107, 0), lineWidth: 7, autoLabel: false },   // @primary-casing #a06b00
    // -- fills (encima, con etiqueta) --
    { file: f('AllStreets'), description: 'AllStreets (OSM)', lineColor: rgb(255, 255, 255), lineWidth: 1, zoomMax: 10, labelZoomMax: 10 },   // blanco (residencial OSM)
    { file: f('Highway2'), description: 'Highway_2 (OSM)', lineColor: rgb(247, 250, 191), lineWidth: 3, labelZoomMax: 30 },   // @secondary-fill #f7fabf
    { file: f('Highway1'), description: 'Highway_1 (OSM)', lineColor: rgb(252, 214, 164), lineWidth: 5, labelZoomMax: 60 },   // @primary-fill #fcd6a4
