...
- [x] **Preview con geometría REAL** (2026-07-27): botón "Mapa real" en el editor -> `readTab` (gdal) lee los `.TAB` por bbox y los dibuja en canvas con tus estilos, en orden (casing incluido), con zoom +/- y arrastrar; se actualiza en vivo al editar. (Se usó canvas propio en vez de MapLibre: más liviano, control total, sin dependencia extra.) Corre en la app Electron (necesita gdal).
